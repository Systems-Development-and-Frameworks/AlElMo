export default ([{ schema, executor }]) => ({
  ...
  Mutation: {
    ...
    delete: (parent, args, context, info) => context.dataSources.db.deletePost(args, context, executor),
    upvote: (parent, args, context, info) => context.dataSources.db.upvotePost(args, context, executor),
